    ...
    >
      ...
      <div className="flex justify-center mt-6 w-full perspective-[1500px]">
        ...
        >
          ...
          <motion.div
            style={{ translateZ: -30 }}
            className="absolute top-0 right-10 text-gray-200 dark:text-white/5 text-9xl pointer-events-none -z-10"
          >
            <LuBrainCircuit />
          </motion.div>
          <motion.div
            style={{ translateZ: -50 }}
            className="absolute bottom-0 left-10 text-gray-200 dark:text-white/5 text-8xl pointer-events-none -z-10"
          >
            <LuTerminal />
          </motion.div>
          ...
          >
            <p className="text-[1.75rem] sm:text-[2.25rem] leading-snug text-gray-900 dark:text-white font-extrabold tracking-tight">
              ...
              <AnimatedText
                ...
                className="text-transparent bg-clip-text bg-gradient-to-r from-cyber-cyan to-neon-violet"
              />
