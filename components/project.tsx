  ...
  return (
    <motion.div
      ...
      style={{
        ...
        top: `calc(10vh + ${index * 40}px)`, // The magic of sticky stacking!
      }}
      className="sticky z-10 w-full mb-12 sm:mb-24 last:mb-0"
    >
      <div className={`group flex flex-col ${isLeft ? 'md:flex-row' : 'md:flex-row-reverse'} gap-8 md:gap-12 items-center bg-gray-50/80 dark:bg-neural-950/80 backdrop-blur-xl border border-black/5 dark:border-white/10 p-6 sm:p-10 rounded-[2rem] shadow-2xl`}>
        ...
        <div className="w-full md:w-1/2 relative">
          <div className="rounded-xl border border-black/10 dark:border-white/10 overflow-hidden shadow-xl bg-white dark:bg-neural-900 group-hover:shadow-[0_0_40px_rgba(6,182,212,0.15)] transition-shadow duration-500">
            {/* Browser Header */}
            <div className="h-8 bg-gray-100 dark:bg-neural-950 border-b border-black/5 dark:border-white/5 flex items-center px-4 gap-2">
            ...
            {/* Image */}
            <div className="relative h-56 sm:h-72 w-full overflow-hidden bg-gray-100 dark:bg-neural-900">
        ...
        <div className={`w-full md:w-1/2 flex flex-col ${isLeft ? 'text-left' : 'text-left md:text-right'} relative z-10`}>
          <div className={`flex items-center gap-3 mb-4 ${isLeft ? 'justify-start' : 'justify-start md:justify-end'}`}>
            ...
            <div className="flex gap-2">
              <button className="p-1.5 rounded-full bg-white dark:bg-white/10 shadow-sm border border-black/5 dark:border-white/5 text-gray-700 dark:text-gray-300 hover:bg-cyber-cyan hover:text-white dark:hover:bg-cyber-cyan transition-colors">
                <LuGithub size={16} />
              </button>
              <button className="p-1.5 rounded-full bg-white dark:bg-white/10 shadow-sm border border-black/5 dark:border-white/5 text-gray-700 dark:text-gray-300 hover:bg-neon-violet hover:text-white dark:hover:bg-neon-violet transition-colors">
          ...
          <p className="leading-relaxed text-sm sm:text-base text-gray-600 dark:text-gray-400 mb-8">
            {description}
          </p>
